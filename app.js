(function () {
  ...
  var characters = [
    ...
    ["첫째 형", "핵심", "assets/characters/anime-v4/02-older-brother-adaptive-evolution-anime-v4.jpg", "어릴 때 납치되어 장로회의 실험 병기와 비밀 4대 원수 후보로 성장한 주인공의 거울. 회색 장발과 구속 장치에 실험체의 시간이 남아 있다.", ["적응 진화", "회색 장발", "비밀 4대 원수 후보"]],
    ...
    ["비극 전의 가족", "핵심", "assets/characters/anime-v4/04-family-before-tragedy-anime-v4.jpg", "인간 어머니와 뱀파이어 아버지, 두 아들, 늑대가 함께했던 짧고 소중한 일상.", ["혼혈 가족", "가족의 일상", "마지막 밤"]],
    ...
    ["거미인간 대장", "동료", "assets/characters/anime-v4/08-spiderfolk-insect-alliance-anime-v4.jpg", "감각이 실린 거미줄의 진동으로 먼 움직임과 안전한 길을 읽는 여성 곤충연합 지도자.", ["감각 거미줄", "진동 감지", "곤충연합"]],
    ...
    ["2대 국가원수", "인간연합", "assets/characters/important/05-second-marshal-fire-swordmaster.jpg", "잿빛 장발과 낡은 검은 외투를 지닌 방랑 검성. 타고난 불을 한 자루의 칼과 보법에 압축하는 세계 최상위 검술가다.", ["불 소울스톤", "한 자루의 칼", "회색 방랑 검성"]],
    ["3대 국가원수", "인간연합", "assets/characters/important/06-third-marshal-telekinesis.jpg", "백발 장발과 감정이 거의 없는 얼굴의 염동력 사용자. 주인공에게 패배한 뒤 살아서 전군 정전을 명령한다.", ["염동력", "무채색 회색", "백발 심판관"]],
    ...
    ["강철의 해군 대장", "인간연합", "assets/characters/important/09-navy-commander-steel.jpg", "날카로운 인상의 흑발 젊은 제독. 강철을 녹이고 굳혀 파도와 무기, 창과 장갑으로 바꾸는 해군 최고 지휘관이다.", ["강철", "흑발 젊은 제독", "함대 지휘"]],
    ...
    ["육군 1번대 중장", "인간연합", "assets/characters/important/11-army-first-lieutenant-shards.jpg", "흉터와 중장갑을 지닌 여성 지휘관. 한 자루의 거대한 검을 수많은 작은 칼날로 분해해 전장을 봉쇄한다.", ["분할 칼날", "흉터 중장갑", "단검 사용자의 옛 상관"]],
