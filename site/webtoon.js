(function () {
  ...
  function renderEpisode(number) {
    ...
    root.innerHTML = '<article class="reader"><header class="episode-head"><small>EPISODE ' + String(number).padStart(2, "0") + '</small><h1>' + data.title + '</h1><p>' + data.subtitle + '</p></header>' + strips + '<footer class="episode-end"><strong>' + number + '화 끝</strong><nav class="episode-nav">' + previous + '<a href="index.html#episodes">60화 목록</a>' + next + '</nav></footer></article>';
    renderSelect();
